...
<body>
	...
	<div id="post">
		<div class="post_left">
			...
			<div class="post_form">
				<form action="xiaoxiServlet?method=add_Searchxiaoxi" enctype="multipart/form-data">
					<tbody>
						<tr><td>信息标题：<input type="text" size="40" name="zhuti"></td></tr><br/>
						<tr><td>丢失物品：<input type="text" size="20" name="wupin"></td></tr><br/>
						...
						<tr><td>联系方式：<input type="text" size="20" name="tel"></td></tr><br/>
		...
		<div class="post_right">
			<img src="images/select-xun.png" width="131" height="131" alt=""/>
		</div>
	</div>
